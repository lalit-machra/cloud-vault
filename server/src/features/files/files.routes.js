...
import { uploadFileController, getFileController, listAllFilesController, deleteFileController, getFileCategoryController, getFileSummaryController } from "./files.controller.js";

const filesRouter = Router();

filesRouter.get("/", authenticateToken, listAllFilesController);
filesRouter.get("/:fileId/category", authenticateToken, getFileCategoryController);
