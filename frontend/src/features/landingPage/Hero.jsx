export function Hero() {
    return (
        <div className="min-h-screen flex flex-col justify-center items-center gap-10 mb-70">
            ...
            <div className="mt-50 rounded-2xl border border-cyan-200 bg-cyan-100/30 shadow-lg shadow-black/5 p-2"><img src="/dashboard-cloud-vault.png" className="h-140 w-full rounded-xl"></img></div>
        </div>
    );
}